    ...
    <>
      <div className="lg:px-32 lg:py-5">
        <h1 className="py-3 px-5 font-bold shadow-sm shadow-black rounded-md">
          ...
          <span className="text-[#1A16D3]">/ TTB1285</span>
        </h1>
        <div className="px-5">
          <div className="mt-5 flex justify-center gap-10 py-3 px-5 font-bold shadow-sm shadow-black rounded-md lg:text-2xl">
            <h1>
            ...
            <div className="bg-[#EDEDED] p-3 rounded-md">
              ...
              <AnimateHeight duration={1000} height={boxOne ? "auto" : 0}>
                <div className="lg:grid lg:grid-cols-2 p-3 gap-5">
                  {/* box-1 */}
                  <div>
                    <h1 className="text-[#1A16D3] font-bold lg:text-2xl">
                      Site Information
                    </h1>
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 bg-[#E5E5E5] py-5 lg:pl-5 rounded-xl">
                      <div className="flex flex-col gap-5 text-right font-bold">
                        <p>Router Model :</p>
                        <p>Router F/W :</p>
                        <p>Router S/N :</p>
                  ...
                  {/* box-5 */}
                  {/* <div>
                    <h1 className="text-[#1A16D3] font-bold lg:text-2xl">SIM 1</h1>
                    <div className="flex gap-2 bg-[#E5E5E5] py-5 pl-5 rounded-xl">
                  ...
                  {/* box-7 */}
                  {/* <div>
                    <h1 className="text-[#1A16D3] font-bold lg:text-2xl">SIM 2</h1>
                    <div className="flex gap-2 bg-[#E5E5E5] py-5 pl-5 rounded-xl">
                      <div className="grid gap-5 text-right font-bold">
                        <p>Main SIM :</p>
                        <p>Call No :</p>
                    ...
                    <div className="flex gap-2 bg-[#E5E5E5] py-5 lg:pl-5 rounded-xl">
                      ...
                      <div className="grid gap-2">
                        <div className="flex flex-wrap lg:gap-3 items-center">
                          ...
                          <input
                            type="number"
                            className="border-2 border-black rounded-lg p-1 w-12"
                          />
                          <span>Mb</span>
                          <input
                            type="number"
                            className="border-2 border-black rounded-lg p-1 w-14"
                          />
                          <span>mbps</span>
                        </div>
                        <div className="flex flex-wrap lg:gap-3 items-center">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 bg-[#E5E5E5] py-5 lg:pl-10 rounded-xl">
