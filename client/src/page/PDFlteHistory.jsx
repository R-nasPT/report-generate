        ...
        <div className="lg:py-8 lg:px-96 min-h-screen flex justify-center items-center lg:flex-col bg-slate-300">
          <div className="grid lg:flex gap-7 lg:gap-2 mb-2">
            <TbArrowBackUp
              ...
              onClick={() => navigate(`/public/view-install/${id}`)}
            />
            {isAdmin && (
              <RiHome2Line
                className="w-32 h-32 p-2 lg:w-10 lg:h-10 lg:p-2 bg-blue-500 lg:hover:bg-blue-400 rounded-xl lg:rounded-md text-white"
                onClick={() => navigate(`/user/install-history`)}
              />
            )}
            <FaDownload
            ...
            >
              <section className="h-[1060px] text-[13px] font-thai-sarabunNew">
                ...
                <div className="flex border-x-[1px] border-b-[1px] border-black">
                  <p className="px-2">
                    {" "}
                    Address : {dataList.siteInfo?.address}
                  </p>
                  <div className="pb-3 text-white">.</div>
                </div>
                {/* Router */}
                ...
                <div className="flex border-x-[1px] border-black">
                  ...
                  <p className="pl-2">
                    Rack S/N : {dataList.routerInfo.rackSN}
                  </p>
                  <div className="pb-3 text-white">.</div>
                </div>
                {/* 7 */}
                ...
                <div className="flex border-[1px] border-black">
                  ...
                  <div className="w-1/4">
                    ...
                    <div>
                      <div>
                        <p className="px-4 font-extrabold pb-2">
                          Customer Site
                        </p>
